...
func TestFormatDurations_withEOD(t *testing.T) {
	...
	entries := []model.LogEntry{
		...
		{Time: chrono.Date(date).At(11, 31), TaskName: "lunch", ExtId: ""},
		...
		{Time: chrono.Date(date).At(16, 30), TaskName: "EOD", ExtId: ""},
	}
...
func TestFormatTotal(t *testing.T) {
	...
	entries := []model.LogEntry{
		{Time: chrono.Date(earlier).At(9, 00), TaskName: "working", ExtId: "SFFEAT0000001"},
		{Time: chrono.Date(earlier).At(17, 00), TaskName: "eod", ExtId: ""},
		{Time: chrono.Date(date).At(9, 30), TaskName: "Designing the timelogger", ExtId: "SFFEAT0000001"},
		{Time: chrono.Date(date).At(12, 00), TaskName: "Implementing the timelogger", ExtId: "SFFEAT0000002"},
		{Time: chrono.Date(date).At(14, 30), TaskName: "Testing the timelogger", ExtId: "SFFEAT0000003"},
	}
...
func TestFormatTotal2(t *testing.T) {
	...
	entries := []model.LogEntry{
		{Time: chrono.Date(earlier).At(9, 30), TaskName: "dsu", ExtId: ""},
		{Time: chrono.Date(earlier).At(10, 00), TaskName: "horse riding", ExtId: ""},
		{Time: chrono.Date(earlier).At(12, 00), TaskName: "eod", ExtId: ""},
		{Time: chrono.Date(date).At(0, 43), TaskName: "early start", ExtId: ""},
	}
...
func TestFormatTotal3(t *testing.T) {
	...
	entries := []model.LogEntry{
		{Time: chrono.Date(earlier).At(9, 30), TaskName: "dsu", ExtId: ""},
		{Time: chrono.Date(earlier).At(9, 45), TaskName: "check email", ExtId: ""},
		{Time: chrono.Date(earlier).At(10, 00), TaskName: "horse riding", ExtId: ""},
		{Time: chrono.Date(earlier).At(11, 45), TaskName: "check email", ExtId: ""},
		{Time: chrono.Date(earlier).At(12, 00), TaskName: "eod", ExtId: ""},
		{Time: chrono.Date(date).At(9, 30), TaskName: "check email", ExtId: ""},
	}
	actual := DurationView(manipulation.Aggregate(entries, date)).Format(Descending)
